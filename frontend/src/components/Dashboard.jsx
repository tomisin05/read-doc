...
export default function Dashboard({ user }) {
  ...
  const modeOptions = [
    ...
    },
    {
      ...
      description: 'Keep only runs with a highlight color applied',
      icon: '◉',
    },
    {
      id: 'underlined',
      label: 'Underlined Only',
      description: 'Keep only underlined runs',
      icon: '◎',
    },
  ]
    ...
    <div className="dashboard">
      ...
      <header className="dash-header">
        <div className="dash-brand">
          ...
          <span className="logo-bracket">]</span>
          <span className="dash-brand-name">Verbatim Extractor</span>
        </div>
      ...
      <main className="dash-main">
        <div className="dash-intro">
          <h2 className="dash-title">Extract Your Evidence</h2>
          <p className="dash-desc">
            Upload a Verbatim-formatted .docx file. Choose which formatting to preserve,
            then download your clean, marked-only document.
          </p>
        </div>
            ...
            {!file ? (
              ...
              >
                ...
                <p className="dropzone-text">
                  {isDragActive ? 'Drop it here' : 'Drag & drop your .docx file'}
                </p>
              ...
              <div className="file-selected">
                ...
                {stage !== 'processing' && stage !== 'uploading' && (
                  <button className="file-remove" onClick={reset} title="Remove">✕</button>
                )}
              </div>
            )}
          </div>
            ...
            <div className="action-area">
                ...
                <div className="processing-state">
                  <div className="progress-ring">
                    <svg viewBox="0 0 60 60" width="80" height="80">
                      <circle cx="30" cy="30" r="24" fill="none" stroke="#1a1a2e" strokeWidth="4"/>
                      <circle
                  ...
                  <p className="processing-label">
                    {stage === 'uploading' ? 'Uploading document...' : 'Extracting marked text...'}
                  </p>
                </div>
              )}
              ...
              {stage === 'done' && (
                <div className="done-state">
                  ...
                  <button className="btn-again" onClick={reset}>Process another file</button>
                </div>
              )}
              ...
              {stage === 'error' && (
                <div className="error-state">
                  ...
                  <button className="btn-again" onClick={() => setStage('idle')}>Try again</button>
                </div>
              )}
              ...
              <div className="action-note">
                ...
                Tags &amp; cites are always preserved. All uploaded files are automatically deleted daily at midnight.
              </div>
            </div>
          </div>
        </div>
